...
input_norma_day_dialog = Dialog(
    Window(
        text.Const(
            ...
            "Пришлите только цифры, например, <b>1650</b>👇"
        ),
    ...
    Window(
        text.Const(
            ...
            "Пришлите только цифры, например, <b>120</b>👇"
        ),
    ...
    Window(
        text.Const(
            ...
            "Пришлите только цифры, например, <b>55</b>👇"
        ),
    ...
    Window(
        text.Const(
            ...
            "Пришлите только цифры, например, <b>220</b>👇"
        ),
        input.TextInput(
            id="input_carbs", 
